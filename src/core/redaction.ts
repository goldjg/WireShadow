import type { ClassificationCategory, RedactedEvidence } from "./types.js";

const MAX_EVIDENCE_LEN = 24;
...
const safeEvidence = (category: ClassificationCategory, value: string): string => {
...
export const redactMany = (
  category: ClassificationCategory,
  values: readonly string[]
): RedactedEvidence[] => values.map((value) => redactValue(category, value));
