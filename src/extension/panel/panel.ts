...
const renderOverview = (
  ...
  const factors = (latestMeaningfulExecution.riskScore?.factors ?? [])
  ...
  const downstreamActivity =
    latestMeaningfulExecution.delegatedExecutionEvent?.downstreamActivityObserved ?? "unknown";
